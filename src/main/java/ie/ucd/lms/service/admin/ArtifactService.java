...
public class ArtifactService {
	...
	public Boolean update(String stringId, String isbn, String type, String genre, String authors, String title,
		...
		if (artifactRepository.existsById(id)) {
			...
			artifact.setAll(isbn, type, genre, authors, title, description, publishers, publishedOn, itemPrice, quantity,
					rackLocation);
	...
	public Boolean create(String isbn, String type, String genre, String authors, String title, String description,
