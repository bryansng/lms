...
public class LoanHistoryService {
    ...
    public Page<LoanHistory> searchAll(String artifact, String member, String fromDate, String toDate, String status,
        ...
        Page<LoanHistory> res = loanHistoryRepository.findAllByArtifactAndMemberAndBothDatesAndStatus(artifactId,
                artifact, memberId, member, fromDateTime, toDateTime, status, pRequest);
        return res;
    }
    ...
    public Page<LoanHistory> searchAllButLost(String artifact, String member, String fromDate, String toDate,
        ...
        switch (dateType.toLowerCase()) {
            case "issued date":
                return loanHistoryRepository.findAllByArtifactAndMemberAndIssuedDateAndStatusNot(artifactId, artifact,
                        memberId, member, fromDateTime, toDateTime, "lost", pRequest);
            case "return date":
                return loanHistoryRepository.findAllByArtifactAndMemberAndReturnDateAndStatusNot(artifactId, artifact,
                        memberId, member, fromDateTime, toDateTime, "lost", pRequest);
            default:
                return loanHistoryRepository.findAllByArtifactAndMemberAndBothDatesAndStatusNot(artifactId, artifact,
                        memberId, member, fromDateTime, toDateTime, "lost", pRequest);
        }
    }
    ...
    public Page<LoanHistory> searchLost(String artifact, String member, String fromDate, String toDate, int pageNum) {
        ...
        Page<LoanHistory> res = loanHistoryRepository.findAllByArtifactAndMemberAndIssuedDateAndStatus(artifactId,
