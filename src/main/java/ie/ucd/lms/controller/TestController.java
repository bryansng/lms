...
public class TestController {
	...
	public void testLoanService() {
		...
		Assert.isTrue(loanHistoryService.searchAllButLost("", "", "", "", Common.nowDate, 0).getTotalElements() == 4,
				" loanHistoryService search() method incorrect.");
		Assert.isTrue(
				loanHistoryService.searchAllButLost("", "", "", Common.nowDate, Common.nowDate, 0).getTotalElements() == 4,
				" loanHistoryService search() method incorrect.");
		...
		Assert.isTrue(
				loanHistoryService.searchAllButLost("", "", Common.nowDate, "", "issued date", 0).getTotalElements() == 4,
				" loanHistoryService search() method with type incorrect.");
		Assert.isTrue(
				loanHistoryService.searchAllButLost("", "", "", Common.nowDate, "issued date", 0).getTotalElements() == 4,
				" loanHistoryService search() method with type incorrect.");
		...
		Assert.isTrue(loanHistoryService.delete("4").isSuccess == true, " loanHistoryService delete() method incorrect.");
	...
	public void testLostService() {
		...
		Assert.isTrue(loanHistoryService.delete("5").isSuccess == true, " loanHistoryService delete() method incorrect.");
	...
	public void testReserveQueueService() {
		...
		Assert.isTrue(reserveQueueService.delete("5").isSuccess == true, " reserveQueueService delete() method incorrect.");
	...
	public void testLoanLimitInLoanHistoryService() {
		Assert.isTrue(
				loanHistoryService.create("9780374275631", "1", "", Common.nowPlus3Date, "0.0", "issued").isSuccess == true,
				" loanHistoryService create() method when Loan Limit reached incorrect.");
		Assert.isTrue(
				loanHistoryService.create("9780374275631", "1", "", Common.nowPlus3Date, "0.0", "issued").isSuccess == true,
				" loanHistoryService create() method when Loan Limit reached incorrect.");
		Assert.isTrue(
				loanHistoryService.create("9780061241895", "1", "", Common.nowPlus3Date, "0.0", "issued").isSuccess == false,
				" loanHistoryService create() method when Loan Limit reached incorrect.");
	}
