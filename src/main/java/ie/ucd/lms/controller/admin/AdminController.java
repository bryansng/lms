...
public class AdminController {
	...
	public void testReturnnFunctionInLoanHistoryService() {
		...
		Assert.isTrue(loanHistoryService.searchAll("", "", "returned", 0).size() == 1,
	...
	public void testRenewFunctionInLoanHistoryService() {
		...
		Assert.isTrue(loanHistoryService.searchAll("", "", "renewed", 0).size() == 1,
	...
	public void testLostFunctionInLoanHistoryService() {
		...
		Assert.isTrue(loanHistoryService.searchAll("", "", "lost", 0).size() == 1,
